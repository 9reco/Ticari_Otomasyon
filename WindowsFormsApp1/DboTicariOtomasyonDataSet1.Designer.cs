...
namespace WindowsFormsApp1 {
    ...
    public partial class DboTicariOtomasyonDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TBL_MUSTERILERDataTable : global::System.Data.TypedTableBase<TBL_MUSTERILERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TBL_MUSTERILERRow AddTBL_MUSTERILERRow(string AD, string SOYAD, string TELEFON, string TELEFON2, string TC, string MAIL, string IL, string ILCE, string ADRES) {
...
namespace WindowsFormsApp1.DboTicariOtomasyonDataSet1TableAdapters {
    ...
    public partial class TBL_MUSTERILERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_MUSTERILER] ([AD], [SOYAD], [TELEFON], [TELEFON2], [TC], [MAIL], [IL], [ILCE], [ADRES]) VALUES (@AD, @SOYAD, @TELEFON, @TELEFON2, @TC, @MAIL, @IL, @ILCE, @ADRES);
SELECT ID, AD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES FROM TBL_MUSTERILER WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TBL_MUSTERILER] SET [AD] = @AD, [SOYAD] = @SOYAD, [TELEFON] = @TELEFON, [TELEFON2] = @TELEFON2, [TC] = @TC, [MAIL] = @MAIL, [IL] = @IL, [ILCE] = @ILCE, [ADRES] = @ADRES WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@IsNull_SOYAD = 1 AND [SOYAD] IS NULL) OR ([SOYAD] = @Original_SOYAD)) AND ((@IsNull_TELEFON = 1 AND [TELEFON] IS NULL) OR ([TELEFON] = @Original_TELEFON)) AND ((@IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)) AND ((@IsNull_TC = 1 AND [TC] IS NULL) OR ([TC] = @Original_TC)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)));
SELECT ID, AD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES FROM TBL_MUSTERILER WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES FROM dbo.TBL_M" +
                "USTERILER";
        ...
        public virtual int Delete(short Original_ID, string Original_AD, string Original_SOYAD, string Original_TELEFON, string Original_TELEFON2, string Original_TC, string Original_MAIL, string Original_IL, string Original_ILCE, string Original_ADRES) {
        ...
        public virtual int Insert(string AD, string SOYAD, string TELEFON, string TELEFON2, string TC, string MAIL, string IL, string ILCE, string ADRES) {
            if ((AD == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_ILCE, 
                    string Original_ADRES) {
            return this.Update(AD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES, Original_ID, Original_AD, Original_SOYAD, Original_TELEFON, Original_TELEFON2, Original_TC, Original_MAIL, Original_IL, Original_ILCE, Original_ADRES, Original_ID);
        }
    }
