...
namespace WindowsFormsApp1.DboTicariOtomasyonDataSetTableAdapters {
    ...
    public partial class TBL_FIRMALARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_FIRMALAR] ([AD], [YETKILISTATU], [YETKILIADSOYAD], [YETKILITC], [SEKTOR], [TELEFON1], [TELEFON2], [TELEFON3], [MAIL], [FAX], [IL], [ILCE], [ADRES], [OZELKOD1], [OZELKOD2], [OZELKOD3]) VALUES (@AD, @YETKILISTATU, @YETKILIADSOYAD, @YETKILITC, @SEKTOR, @TELEFON1, @TELEFON2, @TELEFON3, @MAIL, @FAX, @IL, @ILCE, @ADRES, @OZELKOD1, @OZELKOD2, @OZELKOD3);
SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM TBL_FIRMALAR WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBL_FIRMALAR] SET [AD] = @AD, [YETKILISTATU] = @YETKILISTATU, [YETK" +
                ...
                "AIL, [FAX] = @FAX, [IL] = @IL, [ILCE] = @ILCE, [ADRES] = @ADRES, [OZELKOD1] = @O" +
                "ZELKOD1, [OZELKOD2] = @OZELKOD2, [OZELKOD3] = @OZELKOD3 WHERE (([ID] = @Original" +
                "_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@IsN" +
                "ull_YETKILISTATU = 1 AND [YETKILISTATU] IS NULL) OR ([YETKILISTATU] = @Original_" +
                "YETKILISTATU)) AND ((@IsNull_YETKILIADSOYAD = 1 AND [YETKILIADSOYAD] IS NULL) OR" +
                " ([YETKILIADSOYAD] = @Original_YETKILIADSOYAD)) AND ((@IsNull_YETKILITC = 1 AND " +
                "[YETKILITC] IS NULL) OR ([YETKILITC] = @Original_YETKILITC)) AND ((@IsNull_SEKTO" +
                "R = 1 AND [SEKTOR] IS NULL) OR ([SEKTOR] = @Original_SEKTOR)) AND ((@IsNull_TELE" +
                "FON1 = 1 AND [TELEFON1] IS NULL) OR ([TELEFON1] = @Original_TELEFON1)) AND ((@Is" +
                "Null_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)) " +
                "AND ((@IsNull_TELEFON3 = 1 AND [TELEFON3] IS NULL) OR ([TELEFON3] = @Original_TE" +
                "LEFON3)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)" +
                ") AND ((@IsNull_FAX = 1 AND [FAX] IS NULL) OR ([FAX] = @Original_FAX)) AND ((@Is" +
                "Null_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 A" +
                "ND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_ADRES = 1 AND [AD" +
                "RES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_OZELKOD1 = 1 AND [OZ" +
                "ELKOD1] IS NULL) OR ([OZELKOD1] = @Original_OZELKOD1)) AND ((@IsNull_OZELKOD2 = " +
                "1 AND [OZELKOD2] IS NULL) OR ([OZELKOD2] = @Original_OZELKOD2)) AND ((@IsNull_OZ" +
                "ELKOD3 = 1 AND [OZELKOD3] IS NULL) OR ([OZELKOD3] = @Original_OZELKOD3)));\r\nSELE" +
                "CT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, " +
                "TELEFON3, MAIL, FAX, IL, ILCE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM TBL_FIRM" +
                "ALAR WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON" +
                "2, TELEFON3, MAIL, FAX, IL, ILCE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM dbo.T" +
                "BL_FIRMALAR";
        ...
        public virtual int Update(
            ...
            if ((Original_TELEFON3 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[32].Value = ((string)(Original_TELEFON3));
            }
            if ((Original_MAIL == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[34].Value = ((string)(Original_MAIL));
            }
            if ((Original_FAX == null)) {
            ...
            if ((Original_IL == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[38].Value = ((string)(Original_IL));
            }
            if ((Original_ILCE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[40].Value = ((string)(Original_ILCE));
            }
            if ((Original_ADRES == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_OZELKOD2, 
                    string Original_OZELKOD3) {
            return this.Update(AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3, Original_ID, Original_AD, Original_YETKILISTATU, Original_YETKILIADSOYAD, Original_YETKILITC, Original_SEKTOR, Original_TELEFON1, Original_TELEFON2, Original_TELEFON3, Original_MAIL, Original_FAX, Original_IL, Original_ILCE, Original_ADRES, Original_OZELKOD1, Original_OZELKOD2, Original_OZELKOD3, Original_ID);
        }
    }
